...
DEFAULT_SETTINGS = {   
                    'trial_start' : '/Dev1/port0/line0', # digital outputs (4)
...
def runTrial(di_task, do_task, taskParameters):
    ...
    while True:
        ...
        if time.time() - trial_start_time > taskParameters['trialDuration']:
            print('ending trial')
...
def the_gui():
    ...
    layout = [  [sg.Text('Number of Trials',size=(textWidth,1)), sg.Input(2,size=(inputWidth,1),key='-NumTrials-')],
